...
**Mục tiêu:** service nào cũng trả lỗi theo *cùng một ngôn ngữ* (error code), gateway map/sanitize, không leak lỗi nội bộ.
...
**Vì sao cần?** Senior hay hỏi: *“User báo lỗi, m debug kiểu gì?”* — Observability là câu trả lời.
